###############################################################################
# common_setup.tcl
# Common ICC2 setup for Alarm Clock
...
set NETLIST_FILE $SOURCE_DIR/alarm_clock_compiled.v
set SDC_FILE     $SOURCE_DIR/alarm_clock_out.sdc
