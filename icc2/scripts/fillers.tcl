...
save_block -as alarm_clock_final

write_verilog $RESULT_DIR/alarm_clock_icc2.v

write_sdc -output $RESULT_DIR/alarm_clock_icc2.sdc

write_parasitics \
    -output $RESULT_DIR/alarm_clock_icc2.spef \
    -format spef

write_gds \
    -design alarm_clock_final \
    -layer_map $GDS_MAP \
    -hierarchy all \
    -keep_data_type \
    ...
    $RESULT_DIR/alarm_clock_final.gds
